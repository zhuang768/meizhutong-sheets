...
**真機可一次送出合成申請並寫入試算表**；同一案件重送不會新增第二筆。人工審查分頁的決定可由 App「我的案件」下拉讀回。不得對外宣稱可正式受理市府申請。首頁與說明頁「合成測試案例」都可把桌面 Excel 第 1–20 筆同一組合成情境送到試算表（含合成身分證、發票、切結書；其中 3 筆影像刻意不符）。未連接收件服務時不會假裝已送出。
